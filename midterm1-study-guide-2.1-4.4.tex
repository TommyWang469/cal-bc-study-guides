...
\usepackage{enumitem,multicol,needspace,xcolor,fancyhdr}
\definecolor{navy}{HTML}{16324F}
\definecolor{sky}{HTML}{EAF2F8}
\pagestyle{fancy}
\fancyhf{}
\lhead{\small\textcolor{navy}{Midterm 1 Study Guide}}
...
\newcommand{\prob}[1]{\item[\colorbox{navy}{\textcolor{white}{\textbf{#1}}}]}
\newlist{ans}{itemize}{1}
\setlist[ans]{leftmargin=3.0em,itemsep=5pt,topsep=3pt,label={}}
\newcommand{\ansitem}[1]{\item[\textcolor{navy}{\textbf{#1.}}]}
...
\begin{document}
\begin{center}
{\Huge\bfseries\textcolor{navy}{Midterm 1 Study Guide}}\\[0.4em]
{\large Calculus BC \textbullet\ September 2026}\\[0.9em]
\colorbox{sky}{\parbox{0.88\linewidth}{\centering Show all work. Use the blank space after each question. A complete answer key and source list begin after the practice set.}}
\end{center}
\vspace{0.8em}
\Needspace{7cm}
\begin{probs}
...
\end{probs}
\clearpage
\begin{center}{\LARGE\bfseries\textcolor{navy}{Answer Key}}\end{center}
\medskip
\noindent\textit{Answers correspond to questions 1--57.}
\begin{ans}
...
\clearpage
% === SOURCELIST ===
\begin{center}{\LARGE\bfseries\textcolor{navy}{Where These Questions Came From}}\end{center}
\medskip
